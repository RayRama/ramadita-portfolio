      ...
      <div className="screen-line-after flex border-x border-grid">
        ...
        <div className="flex flex-1 flex-col">
          <div className="flex grow items-end pb-1 pl-4">
            <div className="font-mono text-xs text-zinc-300 select-none dark:text-zinc-600 break-words">
              {"Welcome to my digital garden 🌱"}
              <span className="inline dark:hidden"> where ideas bloom</span>
              <span className="hidden dark:inline"> under the stars</span>
              {" ✨"}
            </div>
          </div>
          ...
          <div className="border-t border-grid">
            <h1 className="flex items-center pl-4 font-heading text-3xl font-medium">
              ...
              &nbsp;
              <SimpleTooltip
                content={`Portfolio website of ${USER.displayName}`}
              >
